...
import com.astuetz.TPagerSlidingTabStrip.IconTabProvider;
...
public class QuickContactFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String[] tabTitles = new String[]{"11111111111111111", "11111112", "11111112"};
        tabs.setShouldExpand(true);
        tabs.setTabAdapter(new TabAdapter(getActivity(), Arrays.asList(tabTitles)));
